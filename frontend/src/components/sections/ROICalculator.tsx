    ...
    return (
        <section id="roi-calculator" className="py-4">
            <div className="container mx-auto px-6">
                ...
                <div className="mt-12">
                                        <button className="px-8 py-3 bg-[hsl(var(--brand-accent))] text-[#2d1b69] font-semibold rounded-lg transition-all duration-300 flex items-center gap-2 group hover:bg-[hsl(var(--brand-accent-dark))] hover:shadow-lg hover:shadow-brand-accent/30 hover:-translate-y-0.5">
                        Collaborate with Us
                        <svg 

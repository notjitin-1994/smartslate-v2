...
exports.deleteUser = exports.setAdminClaim = exports.secureListUsers = exports.listUsers = void 0;
...
const createAdminFunction = (handler) => {
    return (0, https_1.onRequest)({ invoker: 'public' }, (req, res) => {
        // Manually handle CORS preflight
        corsHandler(req, res, (err) => {
            if (err) {
                firebase_functions_1.logger.error("CORS error:", err);
...
exports.secureListUsers = secureListUsers;
exports.setAdminClaim = createAdminFunction(async (req, res) => {
    ...
    try {
        ...
        const users = await (0, exports.secureListUsers)();
